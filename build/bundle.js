...
class FilmItem extends LitElement {
  ...
  render() {
    return html(_templateObject2$1(), this.checkPoster(this.film.Poster), this.film.Title, this.film.Year);
  }
...
function _templateObject3() {
  var data = _taggedTemplateLiteral$2(["<film-item .film=", "></film-item>"]);
...
class AnythingFinder extends LitElement {
  ...
  render() {
    return html(_templateObject2$2(), this.title, this.placeholder, this.films.map(this.drawFilm), repeat(this.films, movie => movie.Title, this.drawFilm));
  }
